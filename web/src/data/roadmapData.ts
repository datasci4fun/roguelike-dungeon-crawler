...
export type Status = 'planned' | 'in-progress' | 'completed' | 'blocked' | 'deferred' | 'archived';
...
export const STATUS_CONFIG: Record<Status, { label: string; color: string; icon: string }> = {
  ...
  archived: { label: 'Don\'t Want', color: '#dc2626', icon: '✗' },
};
...
export const ROADMAP_ITEMS: RoadmapItem[] = [
  ...
  },
  {
    ...
    description: 'Interactive NPC conversations with branching dialogue trees and boss interactions',
    priority: 'high',
    status: 'planned',
    ...
    details: [
      ...
      'Dialogue UI with portrait, name, and text box',
      'Multiple choice responses affecting outcomes',
      'Condition-based dialogue options (items, stats, flags)',
      'Boss pre-fight and post-fight dialogue scenes',
      'Ghost NPC encounters throughout dungeon floors',
      'Dialogue can grant items, hints, or lore entries',
      'Remember previous conversation choices',
      'Interrupt/skip dialogue option',
    ],
  },
  ...
  },
  {
    ...
    description: 'Store user sessions in Redis for faster authentication and scalability',
    priority: 'medium',
    status: 'planned',
    ...
    details: [
      ...
      'Faster auth checks (memory vs database)',
      'Easy session invalidation (logout all devices)',
      'Horizontal scaling support for multiple server instances',
      'Cache Inspector already available for debugging',
    ],
  },
  {
    id: 'med-22',
    title: 'API Rate Limiting',
    description: 'Redis-based rate limiting to prevent API abuse and ensure fair usage',
    priority: 'medium',
    status: 'planned',
    category: ['backend', 'infrastructure'],
    effort: 'small',
    ...
    details: [
      ...
      'Real-time rate limit monitoring via Cache Inspector',
    ],
  },
  {
    id: 'med-23',
    title: 'Leaderboard Caching',
    description: 'Cache leaderboard queries in Redis for instant load times',
    priority: 'medium',
    status: 'planned',
    category: ['backend', 'multiplayer'],
    effort: 'small',
    ...
    details: [
      ...
      'Automatic cache invalidation on new high scores',
      'TTL-based refresh for daily/weekly boards',
  ...
  // ============================================================================
  // v7.X EXPLORATION ROADMAP
  // ============================================================================
  {
    id: 'v7-00',
    title: 'v7.0 Immersive Exploration System',
    description: 'Interactive tile system, puzzles, visual depth, and lore discovery',
    priority: 'high',
    status: 'completed',
    category: ['gameplay', '3d', 'lore'],
    effort: 'epic',
    targetVersion: 'v7.0',
    details: [
      'Interactive tile types: switch, lever, mural, inscription, pressure_plate, hidden_door',
      'PuzzleManager with state tracking and completion events',
      'TileVisual system for elevation, slopes, and set pieces',
      'LorePopup component for mural/inscription discovery',
      'Environmental clues on all 8 floors',
      'Interaction sound effects (switch_flip, lever_pull, etc.)',
      'Puzzle achievements: PUZZLE_SOLVER, PUZZLE_MASTER',
      'Completed 2026-01-16 (PR #78)',
    ],
  },
  {
    id: 'v7-01',
    title: 'v7.1 Zone Layout Designer',
    description: 'Rule-based level editor with model library and Python code generation',
    priority: 'high',
    status: 'completed',
    category: ['frontend', '3d', 'gameplay'],
    effort: 'large',
    targetVersion: 'v7.1',
    dependencies: ['v7-00'],
    details: [
      'Zone Layout Designer at /level-editor',
      'Rule Builder with position strategies, count specs, rotation options',
      'Presets for common patterns (pillars, statues, torches)',
      'Python export generates @register_layout code',
      'Model Library with 4 extracted models (doors, throne, pillar, statue)',
      'Model Generator Claude skill for procedural Three.js models',
      'Bug fixes: DieType export, WebGL context loss, CharacterPreview3D',
      'Completed 2026-01-16 (PR #80)',
    ],
  },
  {
    id: 'v7-01b',
    title: 'Expanded Puzzle Content',
    description: 'Add unique exploration puzzles to all 8 dungeon floors',
    priority: 'high',
    status: 'planned',
    category: ['gameplay', 'content'],
    effort: 'medium',
    ...
    dependencies: ['v7-01'],
    details: [
      'Floor 1 (wardens_office): Switch sequence to open armory',
      'Floor 2 (seal_drifts): Pressure plates to lower water gate',
      'Floor 3 (webbed_gardens): Sequential web wall cutting',
      'Floor 4 (oath_chambers): Mirror reflection switches',
      'Floor 5 (frozen_galleries): Ice slide puzzle to reach platforms',
      'Floor 6 (catalog_chambers): Inscription riddle unlock',
      'Floor 7 (forge_halls): Heat-resistant lever sequence',
      'Floor 8 (geometry_wells): Crystal alignment beam puzzle',
    ],
  },
  {
    id: 'v7-02',
    title: 'v7.2 First-Person Raycasting',
    description: 'Enable mouse-click interaction with walls in first-person view',
    priority: 'high',
    status: 'planned',
    category: ['frontend', '3d', 'gameplay'],
    effort: 'medium',
    ...
    details: [
      ...
      'Hover highlight for interactive elements (subtle glow)',
      '"Press E to interact" prompt when facing interactive tiles',
      'Support both mouse-click and keyboard (E key) interaction',
      'Tag wall meshes with userData.interactive during generation',
    ],
  },
  {
    id: 'v7-03',
    title: 'v7.3 Enhanced Set Pieces & 3D Props',
    description: 'Add dramatic 3D elements to key dungeon locations',
    priority: 'medium',
    status: 'planned',
    category: ['3d', 'content', 'lore'],
    effort: 'large',
    targetVersion: 'v7.3',
    dependencies: ['v7-02'],
    details: [
      'Dungeon Entrance Doors: Massive iron-bound doors behind player at spawn',
      'Warden\'s Throne: Broken throne with lore mural above',
      'Seal Stone: Ancient carved stone with glowing runes',
      'Great Web: Massive spider web spanning ceiling',
      'Mirror of Valdris: Ornate mirror showing distorted reflection',
      'Frozen Waterfall: Ice cascade with trapped souls visible',
      'Forbidden Stacks: Towering bookshelves with floating books',
      'The Crucible: Massive forge with molten metal',
      'Crystal Nexus: Central crystal formation',
      'GLTF models or procedural Three.js groups',
    ],
  },
  {
    id: 'v7-04',
    title: 'v7.4 Secret Room System',
    description: 'Hidden areas rewarding thorough exploration',
    priority: 'medium',
    status: 'planned',
    category: ['gameplay', 'content'],
    effort: 'medium',
    ...
    details: [
      ...
      'Floor 1: Guard\'s Cache (hidden switch behind pillar)',
      'Floor 3: Druid\'s Sanctuary (solve web puzzle)',
      'Floor 5: Frozen Treasury (ice slide to hidden alcove)',
      'Floor 6: Archivist\'s Study (inscription riddle)',
      'Floor 8: True Vault (complete all floor puzzles)',
    ],
  },
  {
    id: 'v7-05',
    title: 'v7.5 Environmental Storytelling',
    description: 'Deepen lore through environmental details and clue chains',
    priority: 'low',
    status: 'planned',
    category: ['lore', 'content'],
    effort: 'large',
    ...
    dependencies: ['v7-00'],
    details: [
      'More mural types with unique art per zone (24-40 total)',
  ...
  {
    id: 'v7-06',
    title: 'v7.6 Puzzle-Environment Integration',
    description: 'Puzzles affect the dungeon environment dynamically',
    priority: 'low',
    status: 'planned',
    category: ['gameplay', '3d'],
    effort: 'large',
    targetVersion: 'v7.6',
    dependencies: ['v7-03', 'v7-04'],
    details: [
