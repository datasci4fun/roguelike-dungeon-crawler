"""Full-screen UI rendering (inventory, character, help, dialog, etc.)."""
import curses
...
# Re-export screens from split modules for backwards compatibility
from .screens_title import render_title_screen, render_intro_screen
from .screens_results import render_game_over, render_victory_screen
...
def render_inventory_screen(stdscr, player: Player, selected_index: int, dungeon_level: int, use_unicode: bool = False):
    ...
    try:
        ...
        # Divider line
        h_char = "-" if not use_unicode else "-"
        ...
        # Controls
        draw_controls(stdscr, "[Up/Down] Select  [E/Enter] Equip/Use  [D] Drop  [I/Q/ESC] Close")
