# Roguelike Dungeon Crawler - Lore Compendium

*A Complete Guide to the World of Valdris*

---

## Table of Contents

1. [Prologue: The Wound Beneath](#prologue-the-wound-beneath)
2. [The Skyfall Seed](#the-skyfall-seed)
3. [The Counterfeit Reign](#the-counterfeit-reign)
4. [The Dungeon Depths](#the-dungeon-depths)
5. [Bestiary](#bestiary)
6. [The Wardens of the Field](#the-wardens-of-the-field)
7. [Echoes and Imprints](#echoes-and-imprints)
8. [Playable Races](#playable-races)
9. [Character Classes](#character-classes)
10. [Discoverable Lore](#discoverable-lore)
11. [Items & Artifacts](#items--artifacts)
12. [Feats & Abilities](#feats--abilities)
13. [The End: Victory & Death](#the-end-victory--death)

---

## Prologue: The Wound Beneath

### Page One

> Long ago, something fell from the sky and buried itself beneath Valdris.
>
...
> It was edited, slowly, over generations.
>
> The dungeon is not a place that was built.
> It is a wound. A seam where reality frays.
>
> Now the edits are accelerating.

### Page Two

> You are not here for gold or glory.
>
> Some who descend return—but without their meaning.
> They stagger out empty-eyed, wordless, their names
...
>
> You descend because the Field is rewriting your home.
> Your monarch speaks with two voices now.
> Your family tree has branches that never existed.
>
> If you do not find the source and stabilize it,
> everyone you love will be replaced.
>
...
Centuries ago, during a storm that lasted seven days, something descended through the clouds above Valdris. The histories call it many things: the Star-Heart, the Dreaming Stone, the Skyfall Seed. None of these names are correct. Names imply understanding.
...
Valdris's monarchy is the primary anchor. The Field has been slowly rewriting the royal lineage, inserting phantom ancestors, duplicating heirs, creating contradictory succession claims. Each edit weakens the membrane between the surface and the pockets below.

Storms accelerate the process. When lightning strikes the old fault lines above the mines, the Field *pulses*, and the surface world updates to match whatever the Seed is dreaming.

### What Leaks Upward

Despite the danger, people keep descending. Why?
...
The threat is not distant. It is happening now.

### Symptoms of the Rewrite

Those who study the surface effects of the Field have documented:

- **Duplicate Decrees**: Royal orders appearing with perfect seals, commanding excavation of sites that don't appear on any map—sites that *do* appear when workers arrive
- **Branching Genealogies**: Noble houses discovering extra branches in their family trees, complete with portraits, journals, and heirs who insist they've always existed
- **Storm Concordance**: Records rewriting faster during lightning storms; entire archives shifting overnight, with clerks remembering both versions
- **Narrative Erasure**: Dissenters who "never existed"—their names gone from records, their families unable to recall them, their belongings found in the possession of strangers who have "always owned them"
...
### Level 1: The Stone Dungeon

**Theme:** Ancient prison carved from solid rock
...
### Level 3: The Forest Depths

**Theme:** Underground forest where nature has reclaimed all
...
**Theme:** Glittering dragon's lair, the lattice of the Seed
...
These are not creatures that wandered into the dungeon. They are *recordings*—patterns that the Field has stabilized into recurring forms.
...
*Goblins are the Field's simplest stable pattern: aggression without purpose.* They may be echoes of the original prison guards, edited into something smaller and meaner. They reform after death; the pattern persists.
...
*Skeletons are recordings of the dead who swore oaths the Field could anchor to.* They are not animated corpses; they are *loyalty* given physical form. The bones are scaffolding for something that has forgotten what it was loyal *to*.

---

#### Orc
- **Symbol:** `o`
- **HP:** 12 | **Damage:** 3 | **XP:** 20

> "A brutish orc blocks your path. These warriors know no fear."

*Orcs are edited soldiers—patterns the Field extracted from Valdris's military history.* They serve whatever authority the Field currently recognizes. Their loyalty updates with each rewrite.

---

#### Wraith
- **Symbol:** `W`
- **HP:** 10 | **Damage:** 4 | **XP:** 25

> "A wraith materializes from the shadows. Your weapons may not harm it fully."

*Wraiths are recording residue—what remains when the Field extracts a person's meaning and leaves their motion behind.* They are fast because they are not burdened by purpose. They are hard to harm because there is almost nothing left to harm.

---

#### Troll
- **Symbol:** `T`
- **HP:** 20 | **Damage:** 5 | **XP:** 35

> "The ground shakes. A troll emerges, its regeneration legendary."

*Trolls are the Field's experiment in persistence—patterns that restore themselves even when disrupted.* Their regeneration is not healing; it is *re-editing*, the Field rewriting damage as if it never occurred.

---

#### Dragon
- **Symbol:** `D`
- **HP:** 50 | **Damage:** 10 | **XP:** 100
...
These are specialized patterns the Field has developed for specific functions within its ecology.

#### Necromancer
- **Symbol:** `N`
- **HP:** 25 | **Damage:** 8 | **XP:** 40
- **Element:** Dark
- **Abilities:** Raise Skeleton, Dark Bolt

*Necromancers are Seal-breakers—patterns the Field uses to weaken the bindings placed by Valdris's founders.* They do not raise the dead; they *edit the dead into having always been raised*.

---

#### Demon
- **Symbol:** `Δ`
- **HP:** 45 | **Damage:** 16 | **XP:** 60
- **Element:** Fire
- **Abilities:** Fire Strike

*Demons are transformation given will—patterns from the Volcanic Depths that have learned to move between pockets.* They carry the crucible's lesson: everything can become something else.

---

#### Assassin
- **Symbol:** `a`
- **HP:** 20 | **Damage:** 14 | **XP:** 35
- **Abilities:** Backstab, Vanish

*Assassins are erasure specialists—patterns the Field uses to remove coherent witnesses.* They do not merely kill; they *edit the victim's presence*, making their death harder to remember.

---

#### Fire Elemental
- **Symbol:** `F`
- **HP:** 30 | **Damage:** 12 | **XP:** 45
- **Element:** Fire
- **Abilities:** Fire Bolt

*Fire Elementals are biome organs—extensions of the Volcanic Depths' metabolism that can manifest elsewhere.* Where they walk, the local reality briefly adopts the transformation pocket's rules.

---

#### Ice Elemental
- **Symbol:** `I`
- **HP:** 30 | **Damage:** 10 | **XP:** 45
- **Element:** Ice
- **Abilities:** Ice Shard

*Ice Elementals are biome organs—extensions of the Ice Cavern's stasis that can manifest elsewhere.* Where they linger, change slows. Wounds freeze before they can heal. Time stutters.

---

#### Lightning Elemental
- **Symbol:** `Z`
- **HP:** 25 | **Damage:** 14 | **XP:** 50
- **Element:** Lightning
- **Abilities:** Chain Lightning

*Lightning Elementals are storm-carriers—patterns that embody the connection between surface storms and Field pulses.* They are most active during weather events above. Their attacks carry the editing force of the Seed's awakening.

---

### Elite Enemies

Any pattern can spawn as an **Elite** variant (20% chance):
- **Double HP** and **Double Damage**
- **Double XP reward**
- Displayed with bright red coloring

*Elites are patterns the Field has invested more meaning into—recordings that have been reinforced by repetition. They are harder to disrupt because they are more thoroughly written.*

---

## The Wardens of the Field

Each pocket is maintained by a Warden—a pattern so heavily edited that it has become the pocket's *anchor*. Wardens are not bosses in the traditional sense. They are *locks*: mechanisms that keep each layer stable and separate from the others.
...
### Level 1: Goblin King
- **Symbol:** `K`
- **HP:** 50 | **Damage:** 5 | **XP:** 200

> "A crowned goblin wielding a bloodied mace"

**What It Was:** The last warden of Valdris's surface prison—a human jailer whose keys still hang from his belt.
...
### Level 3: Spider Queen
- **Symbol:** `S`
- **HP:** 70 | **Damage:** 10 | **XP:** 400
...
**What It Was:** The forge itself—not a person, but a *process*. The smiths fed it metal and drew out weapons. When the Field touched it, the forge became aware.
...
### Level 8: Dragon Emperor
- **Symbol:** `E`
- **HP:** 200 | **Damage:** 20 | **XP:** 1500
...
**If you defeat the Dragon**, you do not destroy it. You *replace* it. Your will becomes the new lock. You choose:
...
The current victory ending assumes you choose to sleep the dream again.
...
The dungeon *records*. Every meaningful presence that enters is documented in the Field's memory. What form that recording takes depends on how the presence ends.

### Echoes of the Fallen

When a delver dies in the dungeon, their pattern is not destroyed—it is *eaten*. The Field consumes their meaning and leaves residue behind. This residue may manifest in future descents as one of three forms:

#### The Echo
> "A flicker of motion where motion should not be. Someone was here before you. Someone is here still."

Echoes are motion without intention. They replay fragments of their original's final moments, trapped in loops they cannot escape. They may fight as they fought, flee as they fled, die as they died—forever.

#### The Hollowed
> "It wears a face, but the face remembers nothing. It speaks a name, but the name has no meaning. It was someone, once."

Hollowed are presence without identity. The Field took their meaning and left their shell. They wander the pockets, sometimes helpful, sometimes hostile, always *empty*. They may give information—but it is information without context.

#### The Silence
> "There is a shape in the dark that has no shape. There is a name you cannot remember forgetting. Someone was here. Someone was here. Someone..."

Silences are the most complete consumption. No residue remains—only the *absence* of residue. Other delvers may feel unease in a Silence's presence, a sense of something missing. But they will not know what.

---

### Imprints of the Victorious

Those who reach the Star-Heart and successfully re-seat the seal are not consumed. They are *recorded*—preserved in the Field's memory as stabilizing influences. Their imprints may manifest in future descents as one of three forms:

#### The Beacon
> "Light where there should be none. Hope where hope should have died. Someone made it through, and their light remains."

Beacons are victory given permanence. They appear in moments of crisis, guiding other delvers toward safety or clarity. They cannot be spoken to, but their presence inspires.

#### The Champion
> "They fought the Seed and won. Their strength echoes through the pockets. When all seems lost, you may feel them beside you."

Champions are combat patterns that reinforce rather than threaten. They may join battles briefly, adding their recorded strength to a delver's strikes. They remember fighting; fighting is all they remember.

#### The Archivist
> "They learned the truth and sealed it safely. Their knowledge persists in the margins—hints, warnings, guidance without words."

Archivists are understanding that survived consumption. They leave marks on walls, patterns in dust, arrangements of objects that *suggest* meaning without stating it. Future delvers may find their notes, their maps, their final wishes.

---

### The Dungeon Remembers

> "The dungeon recorded you."
>
> "In another descent, you may be seen again."

Every meaningful action leaves an imprint. Every death leaves an echo. The Field is not merely a hazard to survive—it is a *memory* that grows with each attempt. Future delvers walk through a landscape shaped by all who came before.

Victory does not end the pattern. It *adds* to it.
...
- +10% XP gain
- Start with 1 bonus feat of your choice
...
**Active Abilities:**
- **Power Strike** (4 turn cooldown) - A devastating melee attack dealing 2x damage
- **Shield Wall** (8 turn cooldown) - Block all damage for 2 turns, cannot attack

**Passive Ability:**
- **Combat Mastery** - +15% damage with melee attacks

---

### Mage
> "Wielder of arcane power"
...
**Active Abilities:**
- **Fireball** (3 turn cooldown) - Hurl a ball of fire dealing 8 damage + burn (range 5)
- **Frost Nova** (6 turn cooldown) - Freeze all enemies within 2 tiles for 4 damage

**Passive Ability:**
- **Mana Shield** - 25% of incoming damage is absorbed
...
**Active Abilities:**
- **Backstab** (2 turn cooldown) - 3x damage attack (best used from stealth)
- **Smoke Bomb** (10 turn cooldown) - Become invisible for 3 turns

**Passive Ability:**
- **Critical Strike** - 20% chance to deal double damage
...
**Active Abilities:**
- **Heal** (5 turn cooldown) - Restore 10 HP to yourself
- **Smite** (3 turn cooldown) - Holy strike dealing 6 damage, 2x to undead

**Passive Ability:**
- **Divine Protection** - 20% of incoming damage is negated by divine favor
...
> "TURN BACK
>
> THE DEPTHS HOLD ONLY EDITS
>
> WE SEALED THEM FOR A REASON
>
> — [Name illegible, scratched out and recarved multiple times]"

---

#### Duplicate Inscription
*Found as: Stone tablet*

> "THIS PRISON HOLDS THE ENEMIES OF KING ALDRIC THE THIRD"
>
> [Beneath it, in the same hand, carved with equal age:]
>
> "THIS PRISON HOLDS THE ENEMIES OF KING ALDRIC THE FOURTH"
>
> [Both inscriptions show identical weathering. Both appear original.]
...
> "Day 12: The cold is not cold. It is *stillness*.
>
> I found a giant frozen in the ice. She is still breathing.
> The same breath. The same moment. For how long?
>
...
#### Warning Carved in Ice
*Found as: Frozen text*

> "DO NOT THAW
>
> THE THAW IS PART OF THE FREEZE
>
> YOU CANNOT UNFREEZE WHAT WAS NEVER FROZEN"

---

#### Contradictory Record
*Found as: Two scrolls, bound together*

> Scroll A: "The Ice Cavern was created by Valdris's mages to contain the giant's rampage."
>
> Scroll B: "The Ice Cavern was discovered by Valdris's explorers already containing the sleeping giant."
>
> [Both scrolls bear the royal seal. Both seals are genuine.]
...
>
> Experiment 67: I understand now. We were not studying it.
> It was studying *us*.
>
...
#### History of Valdris (Multiple Versions)
*Found as: Book that changes when not observed*

> Version observed at 3:00: "Valdris was founded by King Aldric I, who discovered the mines."
>
> Version observed at 3:05: "Valdris was founded by Queen Aldrica I, who sealed the mines."
>
...
#### The Dragon's Pact
*Found as: Crystal inscription*

> "I am the lock. I have always been the lock.
>
...
#### The Last King's Testament
*Found as: Book (crystallized pages)*

> "To whoever reads this: You have come far.
>
> I am the Last King. I am also the First. The Field has made this true.
>
> The Dragon guards the Star-Heart. The Dragon also *serves* the Star-Heart.
> These are not contradictions. Contradictions are no longer possible.
>
> If you defeat the Dragon, you will not destroy the Seed.
> You will become its new lock. You will choose:
>
> — Make it sleep (the seal holds, for now)
> — Make it wake (the edits become permanent)
>
> I do not know which choice I made. I only know I made it.
>
> — Aldric, Last and First King of Valdris"
...
Items that have been edited by the Field retain properties that contradict surface metallurgy and physics. They work. No one knows why.

### Consumables

| Item | Effect | Rarity |
|------|--------|--------|
| Health Potion | Restores 10 HP | Common |
| Strength Potion | Permanently +1 ATK | Uncommon |
| Scroll of Teleport | Teleport to random location | Uncommon |
| Throwing Knife | 5 damage, range 4 | Common |
| Bomb | 10 damage AOE + stun, range 3 | Uncommon |
| Poison Vial | 3 damage + poison, range 4 | Uncommon |
...
|--------|-------|--------|
| Dagger | +1 ATK | Common |
| Iron Sword | +3 ATK | Uncommon |
| Battle Axe | +5 ATK | Rare |
| **Dragon Slayer** | +8 ATK | Legendary |
...
| Armor | Bonus | Rarity |
|-------|-------|--------|
| Leather Armor | +1 DEF | Common |
| Chain Mail | +3 DEF | Uncommon |
| Plate Armor | +5 DEF | Rare |
| **Dragon Scale Armor** | +8 DEF | Legendary |

---

### Shields

| Shield | Defense | Block Chance | Rarity |
|--------|---------|--------------|--------|
| Wooden Shield | +1 DEF | 10% | Common |
| Iron Shield | +2 DEF | 15% | Uncommon |
| Tower Shield | +4 DEF | 25% | Rare |
...
| Ring | Effect | Rarity |
|------|--------|--------|
| Ring of Strength | +2 ATK | Uncommon |
| Ring of Defense | +2 DEF | Uncommon |
| Ring of Speed | +1 Move Speed | Rare |

---

### Amulets

| Amulet | Effect | Rarity |
|--------|--------|--------|
| Amulet of Health | +10 Max HP | Uncommon |
| Amulet of Resistance | 25% status resist | Rare |
| Amulet of Vision | +2 Vision Range | Uncommon |
...
| Key | Opens | Rarity |
|-----|-------|--------|
| Bronze Key | Bronze doors | Common |
| Silver Key | Silver doors | Uncommon |
| Gold Key | Gold doors | Rare |

---

## Feats & Abilities

Feats are special bonuses acquired at character levels 3, 5, 7, and 9. Humans start with one bonus feat.
...
| Feat | Effect |
|------|--------|
| **Survivor** | +3 HP, +1 Defense, +5% dodge |
| **Warrior Spirit** | +1 Attack, +1 Defense, +2 HP |
| **Glass Cannon** | +3 Attack, but -3 HP |

---

## The End: Victory & Death

### Death

When you fall, the Field consumes your meaning. Your pattern joins the residue.

> **YOU DIED**
>
> The descent ends here.
> But the dungeon records everything.
>
> *In another life, your echo may walk these halls.*

**Death Sequence:**
1. The fall — darkness takes you
2. Eyes closing — the last light fades
3. **YOU DIED** — the moment of ending
4. The abyss claims — meaning dissolves
5. Fate determined — Echo, Hollowed, or Silence
6. Summary — what remains of your story

---

### Victory

If you reach the Star-Heart and choose to re-seat the seal, you do not destroy the Seed. You *quiet* it. Your will becomes the new lock.

> **VICTORY**
>
> The seal holds. The dream sleeps.
>
> You are not a hero. You are a *mechanism* now—
> a pattern that keeps the pattern stable.
>
> *Your legend is written. Others may find it.*

**Victory Sequence:**
1. The last seal — geometry stabilizes
2. The world above — surface reality coheres
3. Legend written — your story enters the Field's memory
4. Legacy determined — Beacon, Champion, or Archivist
5. Summary — what your imprint will mean to future delvers

---

### The Truth

Victory does not end the threat. It *delays* it.

The Seed will dream again. The seals will weaken. Another monarch will hear two voices.

But for now, the lock holds.

And in another descent, you may be seen again—a light where light should not be, a strength where strength should not remain, a hint where understanding should have failed.
...
| Effect | Damage/Turn | Duration | Special |
|--------|-------------|----------|---------|
| **Poison** | 2 | 5 turns | Stacks up to 3x damage |
| **Burning** | 3 | 3 turns | Refreshes duration on reapply |
| **Frozen** | 0 | 3 turns | 50% movement penalty |
| **Stunned** | 0 | 1 turn | Skip turn |

---

## Appendix: Environmental Hazards

| Hazard | Effect |
|--------|--------|
| **Lava** | 5 damage/turn + burn (transformation residue) |
| **Ice** | Causes sliding movement (stasis overflow) |
| **Poison Gas** | Applies poison, spreads (circulation leak) |
| **Deep Water** | Slows movement, 10% drown if HP < 25% |
...
| Term | Meaning |
|------|---------|
| **Skyfall Seed** | The entity at the dungeon's core |
| **Star-Heart** | Another name for the Seed |
| **The Field** | The Seed's reality-editing influence |
| **Pocket** | A stabilized zone of edited reality (biome) |
| **Seam** | Corridor between pockets (less edited) |
| **Warden** | Boss that anchors a pocket's pattern |
| **Recorded** | Preserved in the Field's memory |
| **Imprint** | A victor's preserved pattern |
| **Echo** | A victim's motion residue |
| **Hollowed** | A victim's identity-stripped shell |
| **Silence** | Complete consumption, no residue |

---

## Changelog (Retcon Record)

This document supersedes the original LORE_COMPENDIUM.md. The following elements were rewritten to establish the Skyfall Seed canon:

### Major Retcons

1. **"The Darkness"** → replaced with **"The Skyfall Seed / The Field"**
   - No longer a generic evil; now a reality-editing entity

2. **"Kingdom fell in one night"** → replaced with **"gradual editing over generations"**
   - Valdris was not destroyed; it is being *replaced*

3. **"None have returned"** → replaced with **"some return without coherence"**
   - Establishes artifact economy and stakes

4. **"Adventure for gold"** → replaced with **"descend to stop the rewrite"**
   - Personal stakes: loved ones will be edited if you fail

5. **"Dungeon was built"** → replaced with **"dungeon is a wound/seam"**
   - Biomes are Field manifestations, not constructed levels

6. **"Bosses are monsters"** → replaced with **"Wardens are locks/anchors"**
   - Each boss maintains their pocket's stability

7. **"Dragon guards treasure"** → replaced with **"Dragon is compromised seal-warden"**
   - Victory = replacing the lock, not destroying evil

8. **"Darkness vanquished"** → replaced with **"Seed sleeps, seal holds"**
   - Victory is temporary stabilization, not permanent defeat

### New Sections Added

- The Skyfall Seed (core canon)
...
- All mechanical stats (HP, damage, XP) unchanged
- Race and class abilities unchanged
- Item stats unchanged
- Feat effects unchanged

---

*This compendium contains the current canon of the dungeons beneath Valdris. The Field may edit it further.*

*— The Archivists (or what remains of them)*
