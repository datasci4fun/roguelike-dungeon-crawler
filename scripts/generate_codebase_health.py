...
# File patterns that are intentionally large (don't recommend splitting)
# These contain data definitions, complex rendering, or page-specific styles
DATA_FILE_PATTERNS = {
    ...
    'Renderer3D.tsx', 'Renderer.tsx',  # 3D rendering components (Three.js)
    '.css', '.scss',  # Page/component stylesheets (splitting causes specificity issues)
}
