...
## Lessons Learned
- **Always use Glob to find files** - don't guess paths from memory
- **Read scripts first** to understand where outputs go before searching
- **PowerShell > cmd /c** on Windows for showing stdout reliably

Generated: 2026-01-13
Total recommendations: 61 → 57 (after refactoring)
